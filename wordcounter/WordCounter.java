public class WordCounter {
  ...
  public static void main(String[] a) {
    ...
    input.toLowerCase().chars().mapToObj(c -> (char) c).toList().forEach(c -> { if (letters.contains(c)) { if (letterCounter.get(c) != null) { letterCounter.put(c, letterCounter.get(c)+1);} else { letterCounter.put(c,1);}}});
